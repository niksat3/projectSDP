...
<div class="container"><div class="row">
	  ...
	  <nav class="main-nav">
						...
						<li><a id="reservation" href="" class="nav-link">Reservation</a>
							<ul>
							<li><a id="reserve" href="" class="nav-link selected">Reserve</a>
          ...
          <div class="col-md-6 empty">&nbsp;</div>
			...
			<div class="clearfix reserve_form">
				<input type="text" name="name" class="validate['required'] textbox1" placeholder="* Name : "
                    onfocus="this.placeholder = ''" onBlur="this.placeholder = '* Name :'" / value="* Name: <?=$this->session->userdata('user');?>" readonly >
				<input type="text" name="email"  class="validate['required','email']  textbox1"
                    placeholder="* Email : " onFocus="this.placeholder = ''" onBlur="this.placeholder = '* Email :'" value="* Email: <?=$this->session->userdata('email');?>" readonly  />
				<input type="text" name="phone" class="validate['required','phone']  textbox1"
                    placeholder="* Phone : " onFocus="this.placeholder = ''" onBlur="this.placeholder = '* Phone :'" value="* Phone: <?=$this->session->userdata('notelp');?>" readonly  />
				<input type="number" name="amount" class="validate['required']"
                    placeholder="* How Many People? " onFocus="this.placeholder = ''" onBlur="this.placeholder = '* How Many People? '"/>
				...
				<input type='hidden' value="<?=$this->session->userdata('id');?>" name="a" />
